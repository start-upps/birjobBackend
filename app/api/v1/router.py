...
from app.api.v1.endpoints import devices, health, jobs, users, analytics, chatbot, notifications, debug, test_apns
...
api_router.include_router(test_apns.router, prefix="/test", tags=["test"])