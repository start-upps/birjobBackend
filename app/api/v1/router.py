...
from app.api.v1.endpoints import device_registration, minimal_notifications, device_notifications, device_management, device_chatbot, users, privacy, job_analytics
